...
namespace PathFinder
{
    ...
    {
        bool Do<T>(T[] obstacle, int width, int height, Point pstart, Point pend, List<int> steps);
        bool Do<T>(T[] obstacle, int width, int height, Point pstart, Point pend, List<Point> steps);
